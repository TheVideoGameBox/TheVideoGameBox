...
public class VBuscarPet extends JFrame{
	private TPet p;

	public VBuscarPet(TPet p) {
	...
	public void init_GUI() {
		...
		JLabel infoLabel = new JLabel("Información extra: " + p.getInfoExtra());
		...
		formContainer.add(Box.createRigidArea(new Dimension(0, 10)));
		formContainer.add(tipoLabel);
		formContainer.add(Box.createRigidArea(new Dimension(0, 10)));
		formContainer.add(infoLabel);
		formContainer.add(Box.createRigidArea(new Dimension(0, 10)));
