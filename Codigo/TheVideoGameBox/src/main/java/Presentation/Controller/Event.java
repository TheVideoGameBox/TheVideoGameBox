...
public class Event {
    ...
    public static final int DELETE_GAME_FROM_BOX = 513;
    public static final int RES_DELETE_GAME_FROM_BOX_OK = 514;
    public static final int RES_DELETE_GAME_FROM_BOX_KO = 515;
